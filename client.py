...
# --- ЗОБРАЖЕННЯ ----
back = image.load("assets/back.png")
back = transform.scale(back, (WIDTH, HEIGHT))
platform = image.load("assets/platform.png")
platform = transform.rotate(platform, 90)
platform = transform.scale(platform, (20, 100))
# --- ЗВУКИ ---
mixer.init()
hit_sound = mixer.Sound("assets/wall_hit.mp3")
backsound = mixer.Sound("assets/background_music.ogg")
backsound.play(-1)
hit_sound_2 = mixer.Sound("assets/platform_hit.mp3")
# --- ГРА ---
game_over = False
winner = None
you_winner = None
